    ...
    Private Sub ButtonCreateData_Click(sender As Object, e As EventArgs) Handles ButtonCreateData.Click
        ...
        For i As Integer = 1 To TextBoxNumberOfRows.Text
            With DataGridView1.Rows
                .Add(i, "Nama Lengkap " & i, "Laki-Laki", "+021-" & i, "Surabaya")
            End With
        Next
    ...
    Private Sub ButtonClear_Click(sender As Object, e As EventArgs) Handles ButtonClear.Click
        ...
        If DataGridView1.Columns.Count = 0 Then
            With DataGridView1
                .Columns.Clear()
                .Columns.Add("No", "No")
                .Columns.Add("Name", "Nama Lengkap")
                .Columns.Add("Gender", "Jenis Kelamin")
                .Columns.Add("Phone_Number", "No. Telp")
                .Columns.Add("City", "Kota")
            End With
        End If
